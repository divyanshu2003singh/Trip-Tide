...
export default function FetchRideDetailsPage(req, res) {
 ...
 let [dataDetails,setDataDetails]=useState();
  ...
  const fetchRideDetailsPeriodically = () => {
    axios({
      method: "post",
      url: "https://trip-tide-backend.onrender.com/api/ride/getById",
      headers: {
  ...
  async function submitRating() {
    ...
    axios({
      method: "post",
      url: "https://trip-tide-backend.onrender.com/api/ride/rate",
      headers: {
        auth_token: cookies["auth_token"],
      },
      data: {
  ...
  async function driverReachedPickup() {
    axios({
      method: "post",
      url: "https://trip-tide-backend.onrender.com/api/ride/change-status",
      headers: {
        auth_token: cookies["auth_token"],
      },
      data: {
  ...
  console.log(rideDetails);
   return (
    ...
    <div>
    <GoogleMap rideDetails={rideDetails} />
